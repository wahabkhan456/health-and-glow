...
<h1 align="center" style="border-bottom: none !important; margin-bottom: 5px !important;"><a href="https://designrevision.com/downloads/shards-dashboard-lite-react/">Health & Glow React</a></h1>
<p align="center">
  <a href="#">
...
- The layout styles inherited from Health & Glow are pulled in from the `src/shards-dashboard` submodule inside `src/App.js`.
...
If you're looking for something more, check out [Health & Glow Pro React](https://designrevision.com/downloads/shards-dashboard-pro-react/) which features many more custom templates and components. Use the `GITHUB15` coupon code for a **15% discount off the current price**.
